...
"""
            ...
            report_text += "\n\n=============================================================================\n"
            report_text += "DISCLAIMER: This report is generated by an Artificial Intelligence system (AdvancedLungNet) \n"
            report_text += "for academic research and preliminary screening purposes only. It must not be used for medical decisions.\n"
            report_text += "============================================================================="
...
<p style="margin: 5px 0 0 0; color: #6b7280; font-size: 14px;">Automated Diagnostic Report</p>
</div>
...
This report is generated by an academic model for research purposes only. It does not constitute a medical diagnosis.
            ...
            class PDF(FPDF):
                def header(self):
                    ...
                    self.cell(0, 5, "Automated Diagnostic Report", ln=True)
                    # Line
            ...
            disc_text = "This report is generated by an Artificial Intelligence system (AdvancedLungNet) for academic research and preliminary screening purposes only. It does not constitute a medical diagnosis."
